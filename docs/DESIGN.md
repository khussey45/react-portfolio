...
Page order: current robotic arm project, AI and tools, broader toolkit with expandable background, existing projects, contact. Keep the name in the navigation and use natural anchor links.
